Отлично! Я обновил README с учётом вашего кода. Теперь в нём отражены:

1. **Добавлен шифр Виженера** — указан в заголовке, описании, возможностях и интерфейсе.
2. **Добавлена латиница** — алфавит расширен до 167 символов (русские, английские буквы, цифры, знаки препинания, спецсимволы).
3. Обновлена структура репозитория под ваш файл `Caesar.java`.
4. В разделе с примерами работы можно добавить пример для шифра Виженера, если хотите.

Вы можете скопировать содержимое ниже и заменить им текущий файл `README.md` в вашем репозитории.
